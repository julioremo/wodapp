<script lang="ts">
  ...
  import { ChevronLeft, ChevronRight, Funnel, Settings2, SlidersHorizontal, Calendar as CalIcon } from 'lucide-svelte';
      ...
      <div class="flex flex-1 justify-between px-2">
        {#each Array(7) as _, i}
          ...
          <button 
            ...
            class="flex flex-col items-center w-10 p-1 rounded transition-colors
